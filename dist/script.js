...
var accordion = function accordion() {
  var bindAccordion = function bindAccordion(contentActiveClass, contentItemsSelector, triggersActiveClass, triggersItemsSelector) {
    var items = document.querySelectorAll(contentItemsSelector),
...
var cart = function cart(foodItems) {
  ...
  function calcPrice() {
    ...
    document.querySelector('.modal-cart__total-price span').textContent = "$".concat(price);
  }

  function changeQuantity(way, button) {
    var valueContainer = getSibling.call(button, '.modal-cart__items-quantity-value', '.modal-cart__items-item'),
    ...
    var current = +valueContainer.textContent;
    ...
    priceContainer.textContent = "".concat(cartItems[currentId].quantity * cartItems[currentId].price, "$");
    calcPrice();
  ...
  function booking() {
    var itemParams = {};
    var id = this.closest('.food__item').getAttribute('id');
    ...
    foodItems.forEach(function (item) {
      if ("food-item-".concat(item.id) === id) {
  ...
  function bindButtons() {
    var items = cartItemsContainer.querySelectorAll('.modal-cart__items-item');
  ...
  document.addEventListener('ok-cart', function () {
    removeItems();
  });
  cartTriggers.forEach(function (item) {
...
var changeModalState = function changeModalState(state) {
  var setBookingState = function setBookingState() {
    clearState();
    var location = document.querySelector('.modal-restaurant-booking__location-val').innerHTML,
  ...
  var setCartState = function setCartState(obj) {
    var items = JSON.parse(JSON.stringify(obj));
    clearState();
    var total = document.querySelector('.modal-cart__total-price span').textContent;
...
var dropdowns = function dropdowns() {
  var bindDropdown = function bindDropdown(triggerSelector, dropdownClass, activeClass, dropdownsForClosing) {
    ...
    function showDropdown(dropdown) {
      ...
      if (dropdownsForClosing) {
        dropdownsForClosing.forEach(function (item) {
...
var forms = function forms(state) {
  var bindForm = function bindForm(type, formSelector, inputsSelector, btnSelector) {
    ...
    form.addEventListener('submit', function (e) {
      e.preventDefault();
      showResult('loading');
      (0,_services_requests__WEBPACK_IMPORTED_MODULE_6__.postData)('../server.php', form, state).then(function (res) {
        console.log(res);
        showResult('+');
      })["catch"](function () {
        showResult('-');
...
/***/ "./src/js/modules/inputsValidation.js":
/*!********************************************!*\
  !*** ./src/js/modules/inputsValidation.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var menu = function menu(btnSelector, closeSelector, menuSelector, menuContentSelector) {
  ...
  menu.addEventListener('click', function (e) {
    if (e.target.closest(closeSelector)) {
      ...
      menu.querySelectorAll('a').forEach(function (element) {
        if (element === e.target) {
          hideMenu();
        }
      });
...
var modals = function modals() {
  ...
  function bindModal(modalSelector, contentSelector, buttonsSelector, activeClass, closeSelector) {
    var instantly = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : false;
    var bookingItem = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : false;
    var modal = document.querySelector(modalSelector),
        modalContent = document.querySelector(contentSelector),
        close = modal.querySelector(closeSelector);
    modalContent.classList.add('animate__animated'); // Modal content depends on trigger

    if (bookingItem) {
      modal.querySelector('.modal-sub__text').textContent = "".concat(bookingItem.name, " added to your cart");
    }

    if (instantly) {
      showModal(modal, modalContent, activeClass);
    } else {
      document.querySelectorAll(buttonsSelector).forEach(function (button) {
  ...
  function showModal(modal, modalContent, activeClass) {
    allModals.forEach(function (item) {
      if (item !== modal) hideModal(item, modalContent, activeClass);
    });
...
var more = function more(receivedFood) {
  var moreBtn = document.querySelector('.food__more'),
  ...
  function createElements(arr) {
    ...
    arr.forEach(function (obj) {
      ...
      elem.setAttribute("id", "food-item-".concat(obj.id));
      elem.innerHTML = "\n\t\t\t\t<div class=\"food__img\">\n\t\t\t\t\t<picture>\n\t\t\t\t\t\t<source type=\"image/webp\" srcset=\"".concat(obj.src.replace(/[^.]+$/, 'webp'), "\">\n\t\t\t\t\t\t<source type=\"image/jpeg\" srcset=\"").concat(obj.src, "\">\n\t\t\t\t\t\t<img src=\"").concat(obj.src, "\" alt=\"food\">\n\t\t\t\t\t</picture>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"food__info\">\n\t\t\t\t\t<div class=\"food__info-title\">").concat(obj.name, "</div>\n\t\t\t\t\t<div class=\"food__info-text\">").concat(obj.descriptions, "</div>\n\t\t\t\t\t<div class=\"food__info-btn-wrapper\">\n\t\t\t\t\t\t<div class=\"food__info-location\">").concat(obj.location, "</div>\n\t\t\t\t\t\t<div class=\"food__info-btn\">Book Now</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t");
      items.push(elem);
    });
    return items;
  }
  ...
  function renderElements(arr, container) {
    createElements(arr).forEach(function (element) {
  ...
  function showItems(btn, container) {
    ...
    document.querySelectorAll('.food__item').forEach(function (item) {
  ...
  document.addEventListener('have-to-render-food', function () {
    showItems(moreBtn, elemsContainer);
  });
};
...
/***/ "./src/js/modules/restaurantBooking.js":
/*!*********************************************!*\
  !*** ./src/js/modules/restaurantBooking.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var restaurantBooking = function restaurantBooking(receivedRestaurants) {
  var triggerBtn = document.querySelector('.booking__search .button'); // get first element from range (like this: 9-15), and, if its time values transform into "9AM-3PM" form
  ...
  function createBookingItems() {
    var restaurantPerfectContainer = document.querySelector('.modal-restaurants__perfect'),
    ...
    receivedRestaurants.forEach(function (obj) {
      var guestMatch = +guestsOption.match(/^\d+/) >= +obj.guests.match(/^\d+/) && +guestsOption.match(/^\d+/) <= +obj.guests.match(/\d+$/);
  ...
  function renderItems(itemsArr, parent, type) {
    ...
    if (itemsArr.length <= 0) {
      var item = type === 'perfect' ? document.createElement('div') : document.createElement('li');
      item.classList.add('modal-restaurants__fail');
      item.innerHTML = "Sorry, we didn't find such restaurant";
      parent.appendChild(item);
    } else {
      itemsArr.forEach(function (element, i) {
        var item = type === 'perfect' ? document.createElement('div') : document.createElement('li');
        item.classList.add('modal-restaurants__item', "by-".concat(type));
        var number = type === "perfect" ? '' : "\n\t\t\t\t<div class=\"modal-restaurants__number\">\n\t\t\t\t\t<div>\u2116</div><div>".concat(++i, "</div>\n\t\t\t\t</div>\n\t\t\t\t");
        var timeBtns = type === "location" ? '<div class="modal-restaurants__time-inc">+</div><div class="modal-restaurants__time-dec disabled">-</div>' : '';
        var guestsBtns = type === "location" ? '<div class="modal-restaurants__guests-inc">+</div><div class="modal-restaurants__guests-dec disabled">-</div>' : '';
        item.innerHTML = "\n\t\t\t\t".concat(number, "\n\t\t\t\t<div class=\"modal-restaurants__location\">\n\t\t\t\t\t<div>Location:</div><div class=\"modal-restaurants__location-val\">").concat(element.location, "</div>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"modal-restaurants__date\">\n\t\t\t\t\t<div>Date:</div><div class=\"modal-restaurants__date-val\">").concat(element.date, "</div>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"modal-restaurants__time\">\n\t\t\t\t<div>Time:</div><div data-range=\"").concat(element.time, "\" class=\"modal-restaurants__time-val\">").concat(getFirst(element.time, "time"), "</div>").concat(timeBtns, "\n\t\t\t\t</div>\n\t\t\t\t<div class=\"modal-restaurants__guests\">\n\t\t\t\t\t<div>Guests:</div><div data-range=\"").concat(element.guests, "\" class=\"modal-restaurants__guests-val\">").concat(getFirst(element.guests, "guests"), "</div>").concat(guestsBtns, "\n\t\t\t\t</div>\n\t\t\t\t<button data-book class=\"modal-restaurants__book\">\n\t\t\t\t\tBook!\n\t\t\t\t</button>\n\t\t\t\t");
        parent.appendChild(item);
      });
  ...
  function bindOptionBtns(btnsPrevSelector, btnsNextSelector, contentSelector, type) {
    var btnsPrev = document.querySelectorAll(btnsPrevSelector),
    ...
    function bindBtns(btns, way) {
      btns.forEach(function (btn) {
        btn.addEventListener('click', function (e) {
          ...
          var content = getSibling.call(btn, contentSelector, '.by-location'),
              range = content.getAttribute('data-range');
          var answer = changeOption(range, type, way, content.innerHTML);
  ...
  var content = document.querySelector('.modal-restaurants__content');

  function renderBookingFormValues(btnSibling) {
    var locationContainer = document.querySelector('.modal-restaurant-booking__location-val'),
    ...
    var changeValue = function changeValue(elem, valueSelector) {
      var sibling;

      for (var _len = arguments.length, containerSelectors = new Array(_len > 2 ? _len - 2 : 0), _key2 = 2; _key2 < _len; _key2++) {
        containerSelectors[_key2 - 2] = arguments[_key2];
      }

      containerSelectors.forEach(function (selector) {
        if (!sibling) {
          sibling = getSibling.call(btnSibling, valueSelector, selector) ? getSibling.call(btnSibling, valueSelector, selector) : '';
        }
      });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (restaurantBooking);

/***/ }),

/***/ "./src/js/modules/restaurantsOptions.js":
/*!**********************************************!*\
  !*** ./src/js/modules/restaurantsOptions.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var restaurantsOptions = function restaurantsOptions(receivedRestaurants) {
  var dateList = document.querySelector('.booking__params-date .booking__params-dropdown ul'),
  ...
  renderList(guestList, guests, guestOption); // Render list of options in dropdown Elem
  ...
  function sortDates(jsonArr) {
    ...
    var arrSet = Array.from(allDates);
  ...
  function createTimes(date, jsonArr) {
    ...
    jsonArr.forEach(function (obj) {
      for (var key in obj.dates) {
        if (date === key) {
          var start = +obj.dates[key].match(/^\d+/);
          var end = +obj.dates[key].match(/\d+$/);
    ...
    for (startTime; startTime < endTime + 1; startTime++) {
      startTime > 12 ? times.push("".concat(startTime - 12, ".00 PM")) : times.push(startTime + '.00 AM');
    }
  ...
  function createGuests(jsonArr) {
    ...
    var min = 5,
        max = 0;
    jsonArr.forEach(function (obj) {
      var start = +obj.guests.match(/^\d+/);
      var end = +obj.guests.match(/\d+$/);
      min > start ? min = start : min;
      max < end ? max = end : max;
    });

    for (min; min < max + 1; min++) {
      min <= 1 ? guests.add("".concat(min, " Person")) : guests.add("".concat(min, " People"));
    }
  ...
  function bindOption(elemsParent, option, type) {
    elemsParent.addEventListener('click', function (e) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (restaurantsOptions);
...
var scrolling = function scrolling() {
  ...
  function animateScroll(hashValue) {
  ...
  links.forEach(function (link) {
    link.addEventListener('click', function (event) {
      ...
      animateScroll(this.hash);
    });
  });
  document.addEventListener('match', function (event) {
    event.preventDefault();
    animateScroll(event.detail.id);
  });
};
...
var search = function search(receivedFood, receivedRestaurants) {
  var renderedFood = document.querySelectorAll('.food__item'),
      searchButton = document.querySelector('.button.button_main'),
      input = document.querySelector('.preview__search input');

  function compare() {
    var matchedElem, type;

    if (input.value.length > 1) {
      var inputValue = input.value.match(/\w+/g).join(' ').toLowerCase(); // compare food items from markup

      renderedFood.forEach(function (food) {
        var foodName = food.querySelector('.food__info-title').textContent.match(/\w+/g).join(' ').toLowerCase();

        if (foodName === inputValue) {
          matchedElem = "#".concat(food.getAttribute('id'));
          type = "renderedFood";
        }
      }); // compare food items from server

      if (!matchedElem) {
        receivedFood.forEach(function (food) {
          var foodName = food.name.match(/\w+/g).join(' ').toLowerCase();

          if (foodName === inputValue) {
            matchedElem = "#food-item-".concat(food.id);
            type = "receivedFood";
          }
        });
      ...
      if (!matchedElem) {
        receivedRestaurants.forEach(function (restaurant) {
          var itemName = restaurant.location.match(/\w+/g).join(' ').toLowerCase();
  ...
  searchButton.addEventListener('click', function () {
    var _compare = compare(),
        matchedElem = _compare.matchedElem,
        type = _compare.type;
...
var postData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url, data, state) {
    var formData, key, responce;
...
var getResources = /*#__PURE__*/function () {
  ...
  return function getResources(_x4) {
...
/* harmony import */ var _modules_dropdowns__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/dropdowns */ "./src/js/modules/dropdowns.js");
/* harmony import */ var _modules_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/forms */ "./src/js/modules/forms.js");
/* harmony import */ var _assets_libs_swiper_swiper_bundle_esm_browser__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../assets/libs/swiper/swiper-bundle.esm.browser */ "./src/assets/libs/swiper/swiper-bundle.esm.browser.js");
...
/* harmony import */ var _modules_more__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/more */ "./src/js/modules/more.js");
/* harmony import */ var _modules_restaurantsOptions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/restaurantsOptions */ "./src/js/modules/restaurantsOptions.js");
/* harmony import */ var _modules_restaurantBooking__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/restaurantBooking */ "./src/js/modules/restaurantBooking.js");
...
/* harmony import */ var _modules_search__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/search */ "./src/js/modules/search.js");
/* harmony import */ var _services_requests__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./services/requests */ "./src/js/services/requests.js");
...
/* harmony import */ var _modules_phoneMask__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/phoneMask */ "./src/js/modules/phoneMask.js");
/* harmony import */ var _modules_cart__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/cart */ "./src/js/modules/cart.js");
/* harmony import */ var _modules_inputsValidation__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/inputsValidation */ "./src/js/modules/inputsValidation.js");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var modalState = {};
  (0,_services_requests__WEBPACK_IMPORTED_MODULE_11__.getResources)('./db.json').then(function (res) {
    (0,_modules_more__WEBPACK_IMPORTED_MODULE_5__["default"])(res.food);
    (0,_modules_restaurantsOptions__WEBPACK_IMPORTED_MODULE_6__["default"])(res.restaurants);
    (0,_modules_restaurantBooking__WEBPACK_IMPORTED_MODULE_7__["default"])(res.restaurants);
    (0,_modules_search__WEBPACK_IMPORTED_MODULE_10__["default"])(res.food, res.restaurants);
    (0,_modules_cart__WEBPACK_IMPORTED_MODULE_14__["default"])(res.food);
  })["catch"](function () {
    document.dispatchEvent(new CustomEvent("fail"));
  });
  (0,_modules_inputsValidation__WEBPACK_IMPORTED_MODULE_15__["default"])();
  (0,_modules_changeModalState__WEBPACK_IMPORTED_MODULE_9__["default"])(modalState);
  (0,_modules_menu__WEBPACK_IMPORTED_MODULE_0__["default"])('.header__button-burger', '.mobile-menu__close', '.mobile-menu', '.mobile-menu__content');
  (0,_modules_dropdowns__WEBPACK_IMPORTED_MODULE_1__["default"])();
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_2__["default"])(modalState);
  (0,_modules_modals__WEBPACK_IMPORTED_MODULE_4__["default"])();
  (0,_modules_accordion__WEBPACK_IMPORTED_MODULE_8__["default"])();
  (0,_modules_scroll__WEBPACK_IMPORTED_MODULE_12__["default"])();
  (0,_modules_phoneMask__WEBPACK_IMPORTED_MODULE_13__["default"])('[data-phone]');
  var swiper = new _assets_libs_swiper_swiper_bundle_esm_browser__WEBPACK_IMPORTED_MODULE_3__["default"]('.preview__slider-wrapper', {
    loop: true,
    navigation: {
